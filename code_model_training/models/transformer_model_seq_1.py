...
class VisionTransformer(nn.Module):
    def __init__(self, input_dim, num_hiddens, num_heads, num_blks, output_dim, emb_dropout=0.1, blk_dropout=0.1):
        super().__init__()
        ...
        self.pos_embedding = nn.Parameter(
            get_positional_embeddings(self.seq_length + 1, num_hiddens), requires_grad=False
        )
